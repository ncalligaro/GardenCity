...
DROP TABLE heater;
CREATE TABLE heater (id bigint unsigned NOT NULL AUTO_INCREMENT, state varchar(50), reason varchar(50), measurement_date timestamp NULL, created_at timestamp NULL, updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, reason_explanation varchar(255), PRIMARY KEY (id), INDEX measurement_date_ix (measurement_date)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
